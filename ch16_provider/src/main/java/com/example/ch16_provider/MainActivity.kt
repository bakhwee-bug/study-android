...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ssuButton.setOnClickListener{
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("geo:37.49542338727657, 126.95819331938773"))
            startActivity(intent)
        }

        binding.workButton.setOnClickListener{
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("geo: 37.528780630394515, 126.96451016040213"))
            startActivity(intent)
        }
